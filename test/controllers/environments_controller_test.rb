...
class EnvironmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post environments_url, params: { environment: { data: @environment.data, ip_address: @environment.ip_address } }
    end
  ...
  test "should update environment" do
    patch environment_url(@environment), params: { environment: { data: @environment.data, ip_address: @environment.ip_address } }
